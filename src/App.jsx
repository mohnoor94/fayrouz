...
// Color swatches matrix to verify Tailwind tokens
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-fayrouz-obsidian text-fayrouz-cream px-4 py-8 sm:px-8 sm:py-12 flex flex-col items-center">
        ...
        <header className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-fayrouz-border/70 pb-6">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-xs text-fayrouz-muted font-mono">React 18 + Vite + Tailwind + Motion</span>
            </div>
          ...
          <section className="lg:col-span-7 flex flex-col gap-6">
            <div>
              ...
              <p className="text-xs text-fayrouz-muted mt-0.5">
                Demonstrates spring mechanics, dynamic glow, and tap responsiveness for upcoming wizard steps.
              </p>
            </div>
              ...
              <div className="mt-4 pt-4 border-t border-fayrouz-border/60 flex flex-col gap-2">
                ...
                <div className="grid grid-cols-1 gap-1.5 text-xs text-fayrouz-foam/90">
                  <div className="flex items-center gap-2">
                    ...
                    <span>Vite 6 + React 18 HMR online</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-fayrouz-cardamom" />
                    <span>Tailwind v3.4 bespoke theme tokens loaded</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-fayrouz-cardamom" />
                    <span>Google Fonts (Playfair, Inter, Amiri) active</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-fayrouz-cardamom" />
                    <span>Framer Motion spring physics responsive</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-fayrouz-cardamom" />
                    <span>Glassmorphism & Levantine color tokens live</span>
                  </div>
                </div>
              </div>
            </div>
