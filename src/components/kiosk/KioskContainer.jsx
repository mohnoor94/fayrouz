...
export default function KioskContainer() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full py-2">
      ...
      <div className="w-full max-w-6xl h-[720px] rounded-[38px] bg-gradient-to-b from-[#2a2420] via-[#1b1512] to-[#0c0908] p-3 shadow-[0_30px_70px_-15px_rgba(0,0,0,0.95),0_0_0_1px_rgba(212,163,115,0.25),inset_0_1px_1px_rgba(255,255,255,0.15)] flex flex-col relative border border-[#3d2c22]">
